...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            <h2 class="card-title text-center">Scan Barcode with BCR</h2>
            <div class="row ">
                <div class="col-md-6">
...
<div class="container">
    <div class="row">
        <div class="col-md-4"><a href="{{ url('/scan-info') }}">Click Here To Scan for Sale</a></div>
    </div>
</div>
...
<script>
        document.getElementById('barcode').addEventListener('change', function() {
            ...
            window.location.href = '/input-by-barcode/'+barcode;
        });
    </script>
